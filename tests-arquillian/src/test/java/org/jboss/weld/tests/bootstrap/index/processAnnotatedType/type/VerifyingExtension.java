...
import org.jboss.weld.bootstrap.ExtensionObserverMethodResolver;
...
public class VerifyingExtension implements Extension {
    ...
    private ExtensionObserverMethodResolver resolver;
    ...
    void init(@Observes BeforeBeanDiscovery event, BeanManager manager) {
        ...
        this.resolver = new ExtensionObserverMethodResolver(services.get(ClassFileServices.class), services.get(GlobalObserverNotifierService.class).getAllObserverMethods());
